...
#define DEFAULT_FILTER              0  // Default for FILTER 0.025f [-] lower value == softer filter [0, 65535] = [0.0 - 1.0]. REDUCED for direct throttle response
#define DEFAULT_SPEED_COEFFICIENT   24576 // Default for SPEED_COEFFICIENT 1.5f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. INCREASED for maximum performance
